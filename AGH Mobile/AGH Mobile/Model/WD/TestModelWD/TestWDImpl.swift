    ...
    func getScheduleForDays(amount: Int) -> [DaySchedule] {
        let day1 = DaySchedule(date: "15.04.2019", entries: [
            ...
            TimetableEntry(from: "15:00",
                 until: "16:30", course: "CAD / CAM", lecturer: "dr inż. Szczepan Witek", classroom: "B-5 - s. 612", formOfClasses: "ĆL")])
        
        let day2 = DaySchedule(date: "16.04.2019", entries: [
            TimetableEntry(from: "08:00", until: "09:30", course: "CAD / CAM", lecturer: "prof. dr hab. inż. Andriy Milenin", classroom: "B-5 - s. 110", formOfClasses: "W"),
            TimetableEntry(from: "09:45", until: "11:15", course: "Logistyka w hutnictwie", lecturer: "dr inż. Krzysztof Sołek", classroom: "B-5 - s. 104", formOfClasses: "W"),
            TimetableEntry(from: "15:00", until: "16:30", course: "Marketing internetowy", lecturer: "dr inż. Paweł Drożdż", classroom: "B-5 - s. 102", formOfClasses: "W")])
        
        let day3 = DaySchedule(date: "17.04.2019 ", entries: [
            TimetableEntry(from: "08:00", until: "09:30", course: "Internet Engineering", lecturer: "dr hab. inż. Łukasz Rauch", classroom: "B-5 - s. 110", formOfClasses: "W"),
            TimetableEntry(from: "11:30", until: "13:00", course: "Systemy Wbudowane", lecturer: "dr hab. inż. Łukasz Rauch", classroom: "B-4 - s. 122", formOfClasses: "W")])
